...
La suite automatizada cubre dominio, repositorios, migración y caché de persistencia, facade, Remote Config, fallback offline, listas grandes e interacciones de la pantalla principal. Cada fase se valida con Prettier, ESLint, typecheck, pruebas con cobertura, benchmark, build web y builds Android. GitHub Actions repite estas comprobaciones en cada push y pull request.
