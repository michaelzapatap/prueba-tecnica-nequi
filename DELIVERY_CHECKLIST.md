...
- **Funcionalidad:** reglas de tareas/categorías y fallback offline cubiertos por 34 pruebas.
- **Calidad:** TypeScript estricto, arquitectura por capas, SOLID, ESLint y Prettier.
...
- **Automatización:** GitHub Actions valida formato, lint, tipos, auditoría, pruebas, benchmark y build web.
